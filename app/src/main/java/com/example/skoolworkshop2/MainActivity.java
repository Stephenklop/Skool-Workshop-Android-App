...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction()
                .add(R.id.activity_cultureday_details_fragment_txt, new WorkshopOverviewFragment())
                .commit();
    ...
    public void onClick(View v) {
        if (v == mTabsOverviewTv) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.activity_cultureday_details_fragment_txt, new WorkshopOverviewFragment())
                    .commit();
        } else if (v == mTabsContentTv) {
            mTabsSelector.animate().x(mTabsContentTv.getX()).setDuration(100);
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.activity_cultureday_details_fragment_txt, new WorkshopContentFragment())
                    .commit();
        }
    }
}